...
homeControl::homeControl() {
	...
	_HomeLight[HC_LIGHT_GARAGE].httpName = "LIGHT_Garage";
	_HomeLight[HC_LIGHT_GARAGE].niceName = "Garage";

	_HomeLight[HC_LIGHT_ETABLI].httpName = "LIGHT_Etabli";
	_HomeLight[HC_LIGHT_ETABLI].niceName = "Etabli";

	_HomeLight[HC_LIGHT_ATELIER].httpName = "LIGHT_Atelier";
	_HomeLight[HC_LIGHT_ATELIER].niceName = "Atelier";
...
float homeControl::readTargetTempfromRPI(char* name) {
	...
	if (szResultat) {
		pch = strtok(szResultat, ":");
		if (!pch) {
			printf("Error in readTargetTempfromRPI");
			return -100;
		}
		pch = strtok(NULL, ":");
		if (!pch) {
